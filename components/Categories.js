...
export default function Categories() {
    ...
    return (
        <>
            <div className="relative mt-52 mb-20">
                ...
                <div className="px-4">
                <button class="py-2 w-full md:px-4 px-0 bg-gray-500 text-white font-semibold rounded-lg shadow-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75">
                    Become A Retailer
                </button>
                </div>
