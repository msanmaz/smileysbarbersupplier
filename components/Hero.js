...
<div className="relative md:top-32 w-full top-20 md:w-2/3 float-right">
                    ...
                    <div className="flex w-full md:w-2/6 md:mt-44 mt-16 px-2 md:mx-10 float-left">
                        <div className="flex w-full flex-col">
                            <h1 className="font-extrabold font-sans text-7xl dark:text-white text-black">SMILEYS <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-red-500">BARBER</span> SUPPLIER</h1>
