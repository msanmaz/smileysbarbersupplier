...
export default function Navbar() {
    ...
    return (
        <div className="fixed z-50 w-full">
            <div className={` w-full md:px-6 px-0 flex items-center lg:py-4 py-2 bg-black`}>
                <div className="flex my-4">
                    <Link href="/">
            <img src="/Smiley BarberLogo.png" className="fixed h-44 -top-14 -left-8 md:-left-0"/>
                    </Link>
                </div>

                <div className="justify-center pt-2 relative md:mx-auto text-gray-600 md:flex pl-24 md:pl-0">
                    <SearchBar/>
                </div>
